...
./mkvm.sh --user plawson --type server --basefolder /home/plawson --name k8s-node06 --mac 080027978bd5 --cpu 3 --memory 15360 --disk 1048576 --password $1 --salt $2
./mkvm.sh --user plawson --type server --basefolder /home/plawson --name k8s-node07 --mac 080027b18af7 --cpu 3 --memory 15360 --disk 1048576 --password $1 --salt $2
